...
class DirectionApprover extends Model
{
    ...
    /**
     * Obtener el aprobador de dirección asignado para el departamento de un usuario.
     * Retorna el ID del primer aprobador activo asignado o null si no hay ninguno.
     */
